...
Route::get('wishlist/move/{client}/{id}/{anotherId}/{up}', 'Api\ApiWishlistController@moveWishlist');
Route::get('wishlist/move/{client}/{id}/{up}', 'Api\ApiWishlistController@topOrBottomWishlist');
