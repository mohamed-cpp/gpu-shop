...
//        $this->actingAs($this->seller,'seller');
//
//        $file = new UploadedFile( base_path('public/bar.jpg'), 'bar.jpg', null, null, null, true);
//        $file2 = new UploadedFile(public_path("bar.jpg"), 'product2.jpg',  'image/jpg', filesize("public/bar.jpg"),null, true);
